        ...
        privateContainer.perform(query, inZoneWith: nil) { (result, error) in
            ...
            if let records = result {
                ...
                records.forEach{
                    ...
                    membersData.append(MembersDataInSession(id: $0["userID"] as! Int,name: $0["fullName"] as! String, clockIn: $0["joinAt"] as! String, score: $0["score"] as! Int, duration: $0["memberDuration"] as! Int, selectedAnswer: $0["selectedAnswer"] as! String, badgeTitle: $0["badgeTitle"] as! String, badgePicture: $0["badgePicture"] as! String))
